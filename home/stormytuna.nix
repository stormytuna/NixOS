{
  ...
  systemd.user.tmpfiles.rules = [
    "e ${config.home.homeDirectory}/${config.xdg.userDirs.download} - - - 7d"
    "e ${config.home.homeDirectory}/${config.xdg.userDirs.pictures}/screenshots - - - 30d"
    "e ${config.home.homeDirectory}/${config.xdg.userDirs.videos}/screencaps - - - 30d"

    # Nuke Vesktop's stubborn ~/Downloads folder
    "r ${config.home.homeDirectory}/Downloads"
  ];
